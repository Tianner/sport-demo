...
<div class="body-box" style="float:right">
	<form id="jvForm" action="goAdd.do" method="post" enctype="multipart/form-data">
		<table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						颜色:</td><td width="80%" class="pn-fcontent">
							...
							<input type="checkbox" value="22" name="colors"/>西瓜红
							<input type="checkbox" value="26" name="colors"/>西瓜红
							<input type="checkbox" value="27" name="colors"/>西瓜红
							<input type="checkbox" value="28" name="colors"/>西瓜红
							<input type="checkbox" value="29" name="colors"/>西瓜红
							<input type="checkbox" value="30" name="colors"/>西瓜红
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
			...
			<tbody id="tab_2" style="display: none">
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h"></td>
						<td width="80%" class="pn-fcontent">
						<input type="file" onchange="uploadPic()" name="files" multiple="multiple"/>
					</td>
				</tr>
			</tbody>
